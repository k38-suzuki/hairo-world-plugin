...
#ifndef CNOID_JOYSTICKSTART_PLUGIN_CONFIGURABLE_JOYSTICK_H
#define CNOID_JOYSTICKSTART_PLUGIN_CONFIGURABLE_JOYSTICK_H
...
#endif // CNOID_JOYSTICKSTART_PLUGIN_CONFIGURABLE_JOYSTICK_H
