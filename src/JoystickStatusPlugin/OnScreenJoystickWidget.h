...
#ifndef CNOID_JOYSTICK_STATUS_PLUGIN_ON_SCREEN_JOYSTICK_WIDGET_H
#define CNOID_JOYSTICK_STATUS_PLUGIN_ON_SCREEN_JOYSTICK_WIDGET_H
...
#endif // CNOID_JOYSTICK_STATUS_PLUGIN_ON_SCREEN_JOYSTICK_WIDGET_H