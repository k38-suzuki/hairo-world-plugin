...
#ifndef CNOID_JOYSTICK_STATUS_PLUGIN_CONFIGURABLE_JOYSTICK_H
#define CNOID_JOYSTICK_STATUS_PLUGIN_CONFIGURABLE_JOYSTICK_H
...
#endif // CNOID_JOYSTICK_STATUS_PLUGIN_CONFIGURABLE_JOYSTICK_H