...
#ifndef CNOID_VISUALEFFECTPLUGIN_CAMERAVISUALIZERITEM_H
#define CNOID_VISUALEFFECTPLUGIN_CAMERAVISUALIZERITEM_H
...
#endif // CNOID_VISUALEFFECTPLUGIN_CAMERAVISUALIZERITEM_H
