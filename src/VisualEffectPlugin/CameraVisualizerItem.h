...
#ifndef CNOID_VISUAL_EFFECT_PLUGIN_CAMERA_VISUALIZER_ITEM_H
#define CNOID_VISUAL_EFFECT_PLUGIN_CAMERA_VISUALIZER_ITEM_H
...
#endif // CNOID_VISUAL_EFFECT_PLUGIN_CAMERA_VISUALIZER_ITEM_H
