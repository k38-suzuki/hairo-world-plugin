...
#ifndef CNOID_BODY_GENERATOR_PLUGIN_FILE_FORM_WIDGET_H
#define CNOID_BODY_GENERATOR_PLUGIN_FILE_FORM_WIDGET_H
...
#endif // CNOID_BODY_GENERATOR_PLUGIN_FILE_FORM_WIDGET_H